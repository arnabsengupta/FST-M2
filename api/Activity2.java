...
public class Activity2 {
    ...
    public void addNewUserFromFile() throws Exception {
        // Import JSON file
        //File inputJSON = new File("src/test/java/project1/userinfo.json");
        // Read JSON file as String
      //  int size = (int) inputJSON.getChannel().size();
    //    byte[] byteArray = new byte[size];
        //String reqBody = new String(byteArray, inputJSON.read(byteArray));
     // Read JSON file as String
    	String file = "src/test/java/project1/userinfo.json";
    ...
    public void getUserInfo() {
        ...
        File outputJSON = new File("src/test/java/project1/userGETResponse.json");
